...
VtKo4b::VtKo4b(VtSystemType type)
	:VtSystem(type)
{
	InitArgs();
}

VtKo4b::VtKo4b(VtSystemType systemType, std::string name)
...
void VtKo4b::CreateSignal(int startIndex, int endIndex)
{
	if (!_DateTime)
		return;
...
VtPositionType VtKo4b::UpdateSignal(int start, int end)
{
...
void VtKo4b::SetDataMap(VtChartData* chartData)
{
...
void VtKo4b::SaveToXml(pugi::xml_node& node)
{
...
void VtKo4b::LoadFromXml(pugi::xml_node& node)
{
...
/// <returns></returns>
VtPositionType VtKo4b::UpdateSignal(int index)
{
	// 시스템 업데이트
	UpdateSystem(index);
...
void VtKo4b::UpdateSystem(int index)
{
	VtSystem::UpdateSystem(index);
}

void VtKo4b::ReadExtraArgs()
{
	VtSystem::ReadExtraArgs();
}

void VtKo4b::ReloadSystem(int startIndex, int endIndex)
{
	ClearSignal();
	CreateSignal(startIndex, endIndex);
}

bool VtKo4b::CheckEntranceForBuy()
{
...
bool VtKo4b::CheckEntranceForBuy(size_t index)
{
	std::vector<bool> argCond;
...
bool VtKo4b::CheckEntranceForSell()
{
	std::vector<bool> argCond;
...
bool VtKo4b::CheckEntranceForSell(size_t index)
{
	std::vector<bool> argCond;
...
bool VtKo4b::CheckLiqForSell(size_t index)
{
	std::vector<bool> argCond;
...
bool VtKo4b::CheckLiqForBuy(size_t index)
{
	std::vector<bool> argCond;
