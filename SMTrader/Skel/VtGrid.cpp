...
BEGIN_MESSAGE_MAP(VtGrid,CUGCtrl)
	//{{AFX_MSG_MAP(MyCug)
...
VtGrid::VtGrid()
{
	memset(&numberformat, 0x00, sizeof(NUMBERFMT));
	TCHAR bufILZero[3] = { 0 };
...
//	Return:
//		<none>
void VtGrid::OnSheetSetup(int sheetNumber)
{
...
int VtGrid::OnCanMove(int oldcol,long oldrow,int newcol,long newrow)
{
...
int VtGrid::OnCanViewMove(int oldcol,long oldrow,int newcol,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newcol);
...
//	Return:
//		<none>
void VtGrid::OnHitBottom(long numrows,long rowspast,long rowsfound)
{
...
//	Return:
//		<none>
void VtGrid::OnHitTop(long numrows,long rowspast)
{
	UNREFERENCED_PARAMETER(numrows);
	UNREFERENCED_PARAMETER(rowspast);
}
...
int VtGrid::OnCanSizeCol(int col)
{
...
//	Return:
//		<none>
void VtGrid::OnColSizing(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
...
//	Return:
//		<none>
void VtGrid::OnColSized(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*width);
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int VtGrid::OnCanSizeRow(long row)
{
...
//	Return:
//		<none>
void VtGrid::OnRowSizing(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void VtGrid::OnRowSized(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*height);
}
...
int VtGrid::OnSideHdgSizing(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
int VtGrid::OnSideHdgSized(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
//		TRUE - to accept current new size
//		FALSE - to stop sizing, the size is either too large or too small
int VtGrid::OnTopHdgSizing(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//		TRUE - to accept new size
//		FALSE - to revert to old size
int VtGrid::OnTopHdgSized(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//	Return:
//		<none>
void VtGrid::OnColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void VtGrid::OnRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void VtGrid::OnCellChange(int oldcol,int newcol,long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
	UNREFERENCED_PARAMETER(oldrow);
...
//	Return:
//		<none>
void VtGrid::OnLeftColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void VtGrid::OnTopRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void VtGrid::OnViewMoved( int nScrolDir, long oldPos, long newPos )
{
...
//	Return:
//		<none>
void VtGrid::OnSelectionChanged(int startCol,long startRow,int endCol,long endRow,int blockNum)
{
...
//	Return:
//		<none>
void VtGrid::OnLClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void VtGrid::OnRClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void VtGrid::OnDClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void VtGrid::OnMouseMove(int col,long row,POINT *point,UINT nFlags,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void VtGrid::OnTH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void VtGrid::OnTH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void VtGrid::OnTH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void VtGrid::OnSH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void VtGrid::OnSH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void VtGrid::OnSH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void VtGrid::OnCB_LClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void VtGrid::OnCB_RClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void VtGrid::OnCB_DClicked(RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
	UNREFERENCED_PARAMETER(processed);
...
//	Return:
//		<none>
void VtGrid::OnKeyDown(UINT *vcKey,BOOL processed)
{
...
//	Return:
//		<none>
void VtGrid::OnKeyUp(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void VtGrid::OnCharDown(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void VtGrid::OnGetCell(int col,long row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void VtGrid::OnSetCell(int col,long row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*cell);
...
//	Return:
//		<none>
void VtGrid::OnDataSourceNotify(int ID,long msg,long param)
{
...
int VtGrid::OnCellTypeNotify(long ID,int col,long row,long msg,long param)
{
	UNREFERENCED_PARAMETER(ID);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int VtGrid::OnEditStart(int col, long row,CWnd **edit)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int VtGrid::OnEditVerify(int col, long row,CWnd *edit,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
int VtGrid::OnEditFinish(int col, long row,CWnd *edit,LPCTSTR string,BOOL cancelFlag)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
int VtGrid::OnEditContinue(int oldcol,long oldrow,int* newcol,long* newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(*newcol);
...
//	Return:
//		<none>
void VtGrid::OnMenuCommand(int col,long row,int section,int item)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int VtGrid::OnMenuStart(int col,long row,int section)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
DWORD VtGrid::OnGetContextHelpID( int col, long row, int section )
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
int VtGrid::OnHint(int col,long row,int section,CString *string)
{
	UNREFERENCED_PARAMETER(section);
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int VtGrid::OnVScrollHint(long row,CString *string)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int VtGrid::OnHScrollHint(int col,CString *string)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
DROPEFFECT VtGrid::OnDragEnter(COleDataObject* pDataObject)
{
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT VtGrid::OnDragOver(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT VtGrid::OnDragDrop(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void VtGrid::OnScreenDCSetup(CDC *dc,int section)
{
...
int VtGrid::OnSortEvaluate(CUGCell *cell1,CUGCell *cell2,int flags)
{
...
//	Return:
//		<none>
void VtGrid::OnTabSelected(int ID)
{
	UNREFERENCED_PARAMETER(ID);
}
...
//	Return:
//		<none>
void VtGrid::OnAdjustComponentSizes(RECT *grid,RECT *topHdg,RECT *sideHdg,
...
//	Return:
//		<none>
void VtGrid::OnDrawFocusRect(CDC *dc,RECT *rect)
{
...
COLORREF VtGrid::OnGetDefBackColor(int section)
{
	UNREFERENCED_PARAMETER(section);
...
//		<none>
//
void VtGrid::OnSetFocus(int section)
{
	UNREFERENCED_PARAMETER(section);
}
...
//	Return:
//		<none>
void VtGrid::OnKillFocus(int section, CWnd *pNewWnd)
{
	UNREFERENCED_PARAMETER(section);
}

void VtGrid::OnDrawSelectedRect(CDC *dc, RECT *rect)
{
	;
}
...
BOOL VtGrid::OnColSwapStart(int col)
{
	UNREFERENCED_PARAMETER(col);
	return TRUE;
}
...
//		TRUE - to allow for the swap to take place
//		FALSE - to disallow the swap
BOOL VtGrid::OnCanColSwap(int fromCol,int toCol)
{
...
//	Return:
//		<none>
void VtGrid::OnColSwapped(int fromCol,int toCol)
{
	UNREFERENCED_PARAMETER(fromCol);
	UNREFERENCED_PARAMETER(toCol);
}
...
//	Return:
//		<none>
void VtGrid::OnTrackingWindowMoved(RECT *origRect,RECT *newRect)
{
	UNREFERENCED_PARAMETER(*origRect);
	UNREFERENCED_PARAMETER(*newRect);
}

void VtGrid::OnGridWheel()
{

}

void VtGrid::OnGridWheel(int oldCenter, int newCenter)
{

}

void VtGrid::OnMouseLeaveFromMainGrid()
{

}

int VtGrid::thousandsep(double in, char* out_str, size_t out_len, unsigned int precision)
{
...
void ArrowCellType::DrawTransparentBitmap(HDC hdc, HBITMAP hBitmap, short xStart, short yStart, COLORREF cTransparentColor)
{
	BITMAP     bm;
	COLORREF   cColor;
