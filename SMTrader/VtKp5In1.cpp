...
bool VtKp5In1::CheckEntranceForBuy()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtKp5In1::CheckEntranceForSell()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtKp5In1::CheckEntranceByBandForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtKp5In1::CheckEntranceByBandForBuy(size_t index)
{
...
bool VtKp5In1::CheckEntranceByBandForSell()
{
	if (!_Symbol)
		return false;
...
bool VtKp5In1::CheckEntranceByBandForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtKp5In1::CheckEntranceByOpenForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtKp5In1::CheckEntranceByOpenForBuy(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtKp5In1::CheckEntranceByOpenForSell()
{
	if (!_Symbol)
		return false;
...
bool VtKp5In1::CheckEntranceByOpenForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtKp5In1::CheckEntranceForBuy(size_t index)
{
...
bool VtKp5In1::CheckEntranceForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtKp5In1::CheckLiqForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtKp5In1::CheckLiqForBuy(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
