...
bool VtUsComp::CheckEntranceByBandForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsComp::CheckEntranceByBandForBuy(size_t index)
{
...
bool VtUsComp::CheckEntranceByBandForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsComp::CheckEntranceByBandForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsComp::CheckEntranceByOpenForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsComp::CheckEntranceByOpenForBuy(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsComp::CheckEntranceByOpenForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsComp::CheckEntranceByOpenForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
