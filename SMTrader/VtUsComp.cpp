...
bool VtUsComp::CheckEntranceForBuyForUsd()
{
...
bool VtUsComp::CheckEntranceForBuyForUsd(size_t index)
{
	std::vector<bool> argCond;
...
bool VtUsComp::CheckEntranceForSellForUsd()
{
	std::vector<bool> argCond;
...
bool VtUsComp::CheckEntranceForSellForUsd(size_t index)
{
	std::vector<bool> argCond;
...
bool VtUsComp::CheckLiqForSellForUsd()
{
	return VtSystem::CheckLiqForSellForUsd();
}

bool VtUsComp::CheckLiqForSellForUsd(size_t index)
{
	return VtSystem::CheckLiqForSellForUsd(index);
}

bool VtUsComp::CheckLiqForBuyForUsd()
{
	return VtSystem::CheckLiqForBuyForUsd();
}

bool VtUsComp::CheckLiqForBuyForUsd(size_t index)
{
