...
bool VtUsIn2::CheckEntranceForBuyForUsd()
{
...
bool VtUsIn2::CheckEntranceForBuyForUsd(size_t index)
{
	std::vector<bool> argCond;
...
bool VtUsIn2::CheckEntranceForSellForUsd()
{
	std::vector<bool> argCond;
...
bool VtUsIn2::CheckEntranceForSellForUsd(size_t index)
{
	std::vector<bool> argCond;
...
bool VtUsIn2::CheckLiqForSellForUsd()
{
	return VtSystem::CheckLiqForSellForUsd();
}

bool VtUsIn2::CheckLiqForSellForUsd(size_t index)
{
	return VtSystem::CheckLiqForSellForUsd(index);
}

bool VtUsIn2::CheckLiqForBuyForUsd()
{
	return VtSystem::CheckLiqForBuyForUsd();
}

bool VtUsIn2::CheckLiqForBuyForUsd(size_t index)
{
