...
VtUsIn2::VtUsIn2(VtSystemType type)
	:VtSystem(type)
{
	InitArgs();
}

VtUsIn2::VtUsIn2(VtSystemType systemType, std::string name)
...
void VtUsIn2::CreateSignal(int startIndex, int endIndex)
{
	if (!_DateTime)
		return;
...
/// <returns></returns>
VtPositionType VtUsIn2::UpdateSignal(int index)
{
	// 시스템 업데이트
	UpdateSystem(index);
...
VtPositionType VtUsIn2::UpdateSignal(int start, int end)
{
...
void VtUsIn2::SetDataMap(VtChartData* chartData)
{
...
void VtUsIn2::SaveToXml(pugi::xml_node& node)
{
...
void VtUsIn2::LoadFromXml(pugi::xml_node& node)
{
...
void VtUsIn2::UpdateSystem(int index)
{
...
bool VtUsIn2::CheckEntranceForBuy()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtUsIn2::CheckEntranceForSell()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtUsIn2::CheckEntranceByBandForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn2::CheckEntranceByBandForBuy(size_t index)
{
...
bool VtUsIn2::CheckEntranceByBandForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn2::CheckEntranceByBandForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn2::CheckEntranceByOpenForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn2::CheckEntranceByOpenForBuy(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn2::CheckEntranceByOpenForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn2::CheckEntranceByOpenForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn2::CheckEntranceForBuy(size_t index)
{
...
bool VtUsIn2::CheckEntranceForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn2::CheckLiqForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn2::CheckLiqForBuy(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
void VtUsIn2::ReloadSystem(int startIndex, int endIndex)
{
	ClearSignal();
