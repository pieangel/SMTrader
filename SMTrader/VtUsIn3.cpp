...
VtUsIn3::VtUsIn3(VtSystemType type)
	:VtSystem(type)
{
	InitArgs();
}

VtUsIn3::VtUsIn3(VtSystemType systemType, std::string name)
...
void VtUsIn3::CreateSignal(int startIndex, int endIndex)
{
	if (!_DateTime)
		return;
...
/// <returns></returns>
VtPositionType VtUsIn3::UpdateSignal(int index)
{
	// 시스템 업데이트
	UpdateSystem(index);
...
VtPositionType VtUsIn3::UpdateSignal(int start, int end)
{
...
void VtUsIn3::SetDataMap(VtChartData* chartData)
{
...
void VtUsIn3::SaveToXml(pugi::xml_node& node)
{
...
void VtUsIn3::LoadFromXml(pugi::xml_node& node)
{
...
void VtUsIn3::UpdateSystem(int index)
{
...
bool VtUsIn3::CheckEntranceForBuy()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtUsIn3::CheckEntranceForSell()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtUsIn3::CheckEntranceByBandForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn3::CheckEntranceByBandForBuy(size_t index)
{
...
bool VtUsIn3::CheckEntranceByBandForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn3::CheckEntranceByBandForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn3::CheckEntranceByOpenForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn3::CheckEntranceByOpenForBuy(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn3::CheckEntranceByOpenForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn3::CheckEntranceByOpenForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn3::CheckEntranceForBuy(size_t index)
{
...
bool VtUsIn3::CheckEntranceForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn3::CheckLiqForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn3::CheckLiqForBuy(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
void VtUsIn3::ReloadSystem(int startIndex, int endIndex)
{
	ClearSignal();
