...
bool VtUsIn3::CheckEntranceForBuyForUsd()
{
...
bool VtUsIn3::CheckEntranceForBuyForUsd(size_t index)
{
	std::vector<bool> argCond;
...
bool VtUsIn3::CheckEntranceForSellForUsd()
{
	std::vector<bool> argCond;
...
bool VtUsIn3::CheckEntranceForSellForUsd(size_t index)
{
	std::vector<bool> argCond;
...
bool VtUsIn3::CheckLiqForSellForUsd()
{
	return VtSystem::CheckLiqForSellForUsd();
}

bool VtUsIn3::CheckLiqForSellForUsd(size_t index)
{
	return VtSystem::CheckLiqForSellForUsd(index);
}

bool VtUsIn3::CheckLiqForBuyForUsd()
{
	return VtSystem::CheckLiqForBuyForUsd();
}

bool VtUsIn3::CheckLiqForBuyForUsd(size_t index)
{
