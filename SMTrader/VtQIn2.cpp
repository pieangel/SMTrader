...
bool VtQIn2::CheckEntranceForBuyForKosdaq()
{
	return VtSystem::CheckEntranceForBuyForKosdaq();
}

bool VtQIn2::CheckEntranceForBuyForKosdaq(size_t index)
{
	return VtSystem::CheckEntranceForBuyForKosdaq(index);
}

bool VtQIn2::CheckEntranceForSellForKosdaq()
{
	return VtSystem::CheckEntranceForSellForKosdaq();
}

bool VtQIn2::CheckEntranceForSellForKosdaq(size_t index)
{
	return VtSystem::CheckEntranceForSellForKosdaq(index);
}

bool VtQIn2::CheckLiqForSellForKosdaq()
{
	return VtSystem::CheckLiqForSellForKosdaq();
}

bool VtQIn2::CheckLiqForSellForKosdaq(size_t index)
{
	return VtSystem::CheckLiqForSellForKosdaq(index);
}

bool VtQIn2::CheckLiqForBuyForKosdaq()
{
	return VtSystem::CheckLiqForBuyForKosdaq();
}

bool VtQIn2::CheckLiqForBuyForKosdaq(size_t index)
{
