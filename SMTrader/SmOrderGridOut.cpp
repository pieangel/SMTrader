...
{
	SmCallbackManager::GetInstance()->SubscribeQuoteCallback((long)this, std::bind(&SmOrderGridOut::OnQuoteEvent, this, _1));
}
...
{
	SmCallbackManager::GetInstance()->SubscribeHogaCallback((long)this, std::bind(&SmOrderGridOut::OnHogaEvent, this, _1));
}
...
{
	SmCallbackManager::GetInstance()->SubscribeOrderCallback((long)this, std::bind(&SmOrderGridOut::OnOrderEvent, this, _1));
}
