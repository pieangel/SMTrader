...
void HdChartFrm::PlaySignalSound(VtPositionType pos)
{
...
void HdChartFrm::ReleaseResource()
{
...
std::string HdChartFrm::GetMainDataKey()
{
...
int HdChartFrm::CalcChartHeight()
{
...
void HdChartFrm::OnSystemProperty()
{
...
int HdChartFrm::CalcTotalIndexHeight()
{
	int totalHeight = 0;
	int margin = 3;
	for (auto it = IndexVector.begin(); it != IndexVector.end(); ++it)
...
int HdChartFrm::CalcTotalRefChartHeight()
{
	int total = 0;
...
void HdChartFrm::DrawIndex(std::vector<VtLayerInfo>& layerList)
{
...
void HdChartFrm::DrawSignal(DoubleArray& timeStamp, DoubleArray& highArray, DoubleArray& lowArray, DrawArea* drawArea)
{
...
void HdChartFrm::DrawVrobo1Stress(DrawArea* drawArea)
{
...
void HdChartFrm::DrawVrobo2Stress(DrawArea* drawArea)
{
	if (_Data && _TempSystem)
	{
		DoubleArray closeData = DoubleArray(_Data->Close.data() + startIndex, _NoOfPoints);
...
void HdChartFrm::DrawStress(DrawArea* drawArea)
{
	for (auto it = StressVector.begin(); it != StressVector.end(); ++it)
	{
...
void HdChartFrm::DrawDailyLine(DrawArea* d)
{
	if (!_MainChart)
		return;
...
void HdChartFrm::DrawRefChart()
{
	
}

void HdChartFrm::RemoveChartWindow()
{
}

bool HdChartFrm::FindCompareData(VtChartData* data)
{
	/*
...
VtChartData* HdChartFrm::FindCompareData(int index)
{
	return nullptr;
}

void HdChartFrm::AdjustLastData()
{
	
}

int HdChartFrm::GetMaxDataCount()
{
	if (!_Data)
		return 0;
...
void HdChartFrm::GetZoomRange(CChartViewer * a_pChartViewer, int& start, int& end)
{
	start = 0;
	end = 0;
...
void HdChartFrm::SaveToXml(pugi::xml_node& node)
{
	CString msg;
...
void HdChartFrm::LoadFromXml(pugi::xml_node& node)
{
...
void HdChartFrm::ReloadSystem(VtSystem* sys)
{
	if (!sys || !_Data)
		return;
	sys->Running(false);
...
void HdChartFrm::OnReceiveRealtimeData(std::string exc, std::string shortCode, double krwClose, double usdClose /*= 0*/)
{
...
void HdChartFrm::DrawCurrentValue(double close, double usd, DrawArea* drawArea)
{
	PlotArea* plotArea = _MainChart->getPlotArea();
...
void HdChartFrm::DrawCurrentValue(VtLayerInfo&& layerInfo, DrawArea* drawArea)
{
...
void HdChartFrm::DrawRealtimeValues(DrawArea* d)
{
	if (!d)
		return;
...
void HdChartFrm::ResetChart()
{
	_Init = false;
}

void HdChartFrm::DrawTitleValue(DrawArea* drawArea)
{
	PlotArea* plotArea = _MainChart->getPlotArea();
	int plotAreaLeftX = plotArea->getLeftX() + _MainChart->getAbsOffsetX();
	int plotAreaTopY = plotArea->getTopY() + _MainChart->getAbsOffsetY();
...
void HdChartFrm::SetSystem(VtSystemType sysType)
{
...
void HdChartFrm::LoadSystem()
{
	SetSystem(_CurSystemType);
}

void HdChartFrm::UpdateSystem(VtChartData* data, int count)
{
...
void HdChartFrm::UpdateIndex(VtBaseIndex* index)
{
	if (!index)
		return;
	DrawChart(_ChartViewer, 0);
...
void HdChartFrm::DrawChart(CChartViewer * a_pChartViewer, int mode)
{
...
void HdChartFrm::SetChartData(VtChartData* a_ChartData)
{
...
void HdChartFrm::OnRButtonDown(UINT nFlags, CPoint point)
{

}

void HdChartFrm::OnLButtonDown(UINT nFlags, CPoint point)
{
	HitTest(point);
...
void HdChartFrm::OnMouseMove(UINT nFlags, CPoint point)
{
	VtPoint mousePoint;
	MouseToChart(point, mousePoint);
	mousePoint.x -= _offset.x;
...
void HdChartFrm::OnLButtonDblClk(UINT nFlags, CPoint point)
{
	if (_SelectedSystem)
	{
		OnSystemProperty();
...
void HdChartFrm::PixelToValue(VtPoint& location0, VtPoint& location1, bool byValue)
{

}

void HdChartFrm::PixelToValue()
{
	int startIndex = 0;
	int endIndex = 0;
...
void HdChartFrm::initChartViewer(CChartViewer *viewer)
{
	if (_Init) return;
...
void HdChartFrm::CreateLineWithOrder(VtOrder* order)
{
	if (!order || !_MainChart)
		return;
...
void HdChartFrm::PutOrder(POINT& pt, VtOrderCmd cmd, int qty)
{
	if (!_MainChart || !_Data)
		return;
...
void HdChartFrm::AddPreOrder(VtOrder* order)
{
...
void HdChartFrm::OnAccepted(VtOrder* order)
{
	if (!order) return;
...
void HdChartFrm::OnFilled(VtOrder* order)
{
	if (!order) return;
...
void HdChartFrm::OnConfirmModify(VtOrder* order)
{
	if (!order) return;
...
void HdChartFrm::OnConfirmCancel(VtOrder* order)
{
	if (!order) return;
...
void HdChartFrm::OrderArrived(VtOrder* order)
{
	if (!order) return;
	if (order->state != VtOrderState::Accepted)
		return;
...
void HdChartFrm::ChangeOrder(int yPos, VtElement* selObj)
{
	if (!selObj)
		return;
...
void HdChartFrm::InitChartIndex()
{
...
void HdChartFrm::ShowChartIndex(int index)
{
	if (!_ParentChartWnd || !_ChartViewer)
		return;
...
void HdChartFrm::DeleteAllChartIndex()
{
	int i = 0;
	for (auto it = IndexVector.begin(); it != IndexVector.end(); ++it)
	{
...
void HdChartFrm::OnReceiveChartData(VtChartData* data)
{
	if (!data)
		return;
	DrawChart(_ChartViewer, 0);
...
void HdChartFrm::OnReceiveQuoteHd(VtSymbol* sym)
{
	if (!sym)
		return;
	DrawChart(_ChartViewer, 0);
...
void HdChartFrm::DrawSelected(DoubleArray& xData, DoubleArray& yData, XYChart* chart)
{
	if (!chart)
		return;
...
void HdChartFrm::DrawSelected(DoubleArray& xData, DrawArea* d, int startIndex, int nofPoints)
{
	if (!d)
		return;
}

void HdChartFrm::ValueToPixel(VtValue& value0, VtValue& value1, bool byValue)
{

}

void HdChartFrm::ValueToPixel()
{
	int startIndex = 0;
	int endIndex = 0;
	GetZoomRange(_ChartViewer, startIndex, endIndex);
...
void HdChartFrm::DeleteSelectedObject()
{
	_shapesCollection.DeleteSelectedObject();
	if (_ChartViewer != nullptr)
		DrawChart(_ChartViewer, 0);
...
void HdChartFrm::DeleteAllObjects()
{
...
void HdChartFrm::SetChartSize(int width, int height)
{
	_Width = width;
	_Height = height;
...
void HdChartFrm::AddCompareData(VtChartData* data)
{
	if (!data || !_Data)
		return;
...
void HdChartFrm::RemoveCompareData(std::string key)
{
	
}

void HdChartFrm::RemoveCompareData(VtChartData* data)
{
...
/// <returns></returns>
bool HdChartFrm::HitTestSymbol(CPoint point)
{
	if (!_SourceChart)
		return false;
...
void HdChartFrm::HitTest(CPoint point)
{
...
bool HdChartFrm::HitTestSystem(CPoint point)
{
	if (!_MainChart)
		return false;
	if (!_System)
...
void HdChartFrm::DeleteRefChartData()
{
	int i = 0;
	for (auto it = _LayerList.begin(); it != _LayerList.end(); ++it)
	{
...
void HdChartFrm::InsertIndex(CMFCPropertyGridProperty* prop)
{
	if (!prop)
		return;
...
void HdChartFrm::InsertIndex(VtIndexBase* indexBase)
{
	if (!indexBase)
		return;
...
void HdChartFrm::DeleteIndex(int num)
{
...
void HdChartFrm::InsertBand(VtBandBase* band)
{
	if (!band)
		return;
...
void HdChartFrm::UpdateBand(VtBaseBand* band)
{
	if (!band)
		return;
	DrawChart(_ChartViewer, 0);
...
void HdChartFrm::DeleteBand(int num)
{
...
void HdChartFrm::InsertStress(VtStressBase* stress)
{
	if (!stress)
		return;
...
void HdChartFrm::UpdateStress(VtBaseStress* stress)
{
	if (!stress)
		return;
	DrawChart(_ChartViewer, 0);
...
void HdChartFrm::DeleteStress(int num)
{
...
void HdChartFrm::UpdateReferenceChart(VtReferenceChart* refChart)
{
	if (!refChart)
		return;
...
void HdChartFrm::InsertSystem(int index)
{
	if (index < 0)
		return;
	VtGlobal* global = VtGlobal::GetInstance();
...
void HdChartFrm::OnLButtonUp(UINT nFlags, CPoint point)
{
	int sx = _start.x;
	int sy = _start.y;
	//CalcPixelSize();
...
void HdChartFrm::ShowAllIndex(bool flag)
{
	for (auto it = IndexVector.begin(); it != IndexVector.end(); ++it)
	{
		VtBaseIndex* index = *it;
...
void HdChartFrm::ShowAllReferenceChart(bool flag)
{
	for (auto it = RefChartVector.begin(); it != RefChartVector.end(); ++it)
	{
		VtReferenceChart* chart = *it;
...
VtBaseIndex* HdChartFrm::FindIndex(std::string indexName)
{
	for (auto it = IndexVector.begin(); it != IndexVector.end(); ++it)
	{
		VtBaseIndex* index = *it;
...
VtBaseBand* HdChartFrm::FindBand(std::string bandName)
{
	for (auto it = BandVector.begin(); it != BandVector.end(); ++it)
	{
		VtBaseBand* band = *it;
...
VtBaseStress* HdChartFrm::FindStress(std::string stressName)
{
	for (auto it = StressVector.begin(); it != StressVector.end(); ++it)
	{
		VtBaseStress* stress = *it;
...
void HdChartFrm::MouseToChart(CPoint src, VtPoint & des)
{
	des.x = src.x;
	des.y = src.y;
}

void HdChartFrm::DrawInstantObject()
{
...
void HdChartFrm::DrawObjects(int idStart, int zoomStartIndex, DrawArea* d, XYChart* chart, int dx, int dy)
{
...
void HdChartFrm::DrawObjects(XYChart * chart, DrawArea* d)
{
...
void HdChartFrm::DrawSelection(DrawArea* d)
{
	if (_SourceChart == nullptr)
		return;
...
void HdChartFrm::DrawCreatingObject(DrawArea* d)
{
	if (_SourceChart == nullptr)
		return;
...
void HdChartFrm::ChangeDimension()
{
	PixelToValue();
...
//
void HdChartFrm::trackFinance(MultiChart *m, int mouseX)
{
...
void HdChartFrm::DrawTrackLine(MultiChart*m, int mouseX)
{
	if (!m)
		return;
...
Axis* HdChartFrm::FindAxis(std::string dataName)
{
	for (auto it = _LayerList.begin(); it != _LayerList.end(); ++it)
	{
		VtLayerInfo layerInfo = *it;
