...
VtEntireBand::VtEntireBand(VtBandType type)
	:VtBaseBand(type)
{
	HighColor = 0xff0000;
	LowColor = 0x0000ff;
...
void VtEntireBand::SaveToXml(pugi::xml_node& node)
{
...
void VtEntireBand::LoadFromXml(pugi::xml_node& node)
{
