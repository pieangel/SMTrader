...
VtTrUs3::VtTrUs3(VtSystemType type)
	:VtSystem(type)
{
	InitArgs();
}

VtTrUs3::VtTrUs3(VtSystemType systemType, std::string name)
...
void VtTrUs3::CreateSignal(int startIndex, int endIndex)
{
	if (!_DateTime)
		return;
...
/// <returns></returns>
VtPositionType VtTrUs3::UpdateSignal(int index)
{
	// 시스템 업데이트
	UpdateSystem(index);
...
VtPositionType VtTrUs3::UpdateSignal(int start, int end)
{
...
void VtTrUs3::SetDataMap(VtChartData* chartData)
{
...
void VtTrUs3::SaveToXml(pugi::xml_node& node)
{
...
void VtTrUs3::LoadFromXml(pugi::xml_node& node)
{
...
void VtTrUs3::UpdateSystem(int index)
{
...
bool VtTrUs3::CheckEntranceForBuy()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtTrUs3::CheckEntranceForSell()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtTrUs3::CheckEntranceByBandForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtTrUs3::CheckEntranceByBandForBuy(size_t index)
{
...
bool VtTrUs3::CheckEntranceByBandForSell()
{
	if (!_Symbol)
		return false;
...
bool VtTrUs3::CheckEntranceByBandForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtTrUs3::CheckEntranceByOpenForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtTrUs3::CheckEntranceByOpenForBuy(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtTrUs3::CheckEntranceByOpenForSell()
{
	if (!_Symbol)
		return false;
...
bool VtTrUs3::CheckEntranceByOpenForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtTrUs3::CheckEntranceForBuy(size_t index)
{
...
bool VtTrUs3::CheckEntranceForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtTrUs3::CheckLiqForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtTrUs3::CheckLiqForBuy(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
void VtTrUs3::ReloadSystem(int startIndex, int endIndex)
{
	ClearSignal();
