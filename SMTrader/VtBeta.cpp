...
VtBeta::VtBeta(VtSystemType type)
	:VtSystem(type)
{
	InitArgs();
}

VtBeta::VtBeta(VtSystemType systemType, std::string name)
...
void VtBeta::CreateSignal(int startIndex, int endIndex)
{
	if (!_DateTime)
		return;
...
/// <returns></returns>
VtPositionType VtBeta::UpdateSignal(int index)
{
	// 시스템 업데이트
	UpdateSystem(index);
...
VtPositionType VtBeta::UpdateSignal(int start, int end)
{
...
void VtBeta::SetDataMap(VtChartData* chartData)
{
...
void VtBeta::SaveToXml(pugi::xml_node& node)
{
...
void VtBeta::LoadFromXml(pugi::xml_node& node)
{
...
void VtBeta::UpdateSystem(int index)
{
...
bool VtBeta::CheckEntranceForBuy()
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
...
bool VtBeta::CheckEntranceForSell()
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
	std::vector<bool> argCond;
	// 매수 진입
...
VtPositionType VtBeta::CheckEntranceForBuy(size_t index)
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
	std::vector<bool> argCond;
	// 매수 진입
...
VtPositionType VtBeta::CheckEntranceForSell(size_t index)
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
	std::vector<bool> argCond;
	// 매수 진입
...
VtPositionType VtBeta::CheckLiqForSell(size_t index)
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
	VtSymbol* sym = prdtCatMgr->GetRecentFutureSymbol(_T("101F"));
...
VtPositionType VtBeta::CheckLiqForBuy(size_t index)
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
	VtSymbol* sym = prdtCatMgr->GetRecentFutureSymbol(_T("101F"));
...
void VtBeta::ReloadSystem(int startIndex, int endIndex)
{
	ClearSignal();
