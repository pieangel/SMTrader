...
public:
	...
	virtual void SetLabel(LPCTSTR szLabel ) {
		m_strLabel = szLabel; 
	}
	virtual LPCTSTR    GetLabel() const {
		return m_strLabel;
	}
	...
	virtual bool GetClicked() const { return _Clicked; }
...
protected:
    ...
    int        m_nImage;       // Index of the list view itemís icon
    DWORD      m_nFormat;
    COLORREF   m_crFgClr;
    COLORREF   m_crBkClr;
    LOGFONT*   m_plfFont;
