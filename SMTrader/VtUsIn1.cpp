...
bool VtUsIn1::CheckEntranceForBuy()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtUsIn1::CheckEntranceForSell()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtUsIn1::CheckEntranceByBandForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn1::CheckEntranceByBandForBuy(size_t index)
{
...
bool VtUsIn1::CheckEntranceByBandForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn1::CheckEntranceByBandForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn1::CheckEntranceByOpenForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn1::CheckEntranceByOpenForBuy(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn1::CheckEntranceByOpenForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsIn1::CheckEntranceByOpenForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn1::CheckEntranceForBuy(size_t index)
{
...
bool VtUsIn1::CheckEntranceForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn1::CheckLiqForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsIn1::CheckLiqForBuy(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
