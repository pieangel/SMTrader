...
public:
	...
	void SetHasFixedCenter(bool value)
	{
		m_HasFixedCenter = value;
	}
	bool GetHasFixedCenter()
	{
		return m_HasFixedCenter;
	}

	void SetCenterRow(long value)
	{
		m_CenterRow = value;
	}
...
protected:
	UGMode m_UGMode;
	bool m_HasFixedCenter = false;
	long m_CenterRow;

private:
	RECT* RcSelected = nullptr;
// Operations
public:
	...
	std::vector<VtArrowPos> ArrowPosVector;
	void AddArrowPos(VtArrowPos&& pos)
	{
		ArrowPosVector.push_back(pos);
	}

	void ClearArrowPos()
	{
		ArrowPosVector.clear();
	}
