...
void CUGCtrl::OnDrawSelectedRect(CDC *dc, RECT *rect)
{
...
void CUGCtrl::OnGridWheel()
{

}

void CUGCtrl::OnGridWheel(int oldCenter, int newCenter)
{

}

void CUGCtrl::OnMouseLeaveFromMainGrid()
{
