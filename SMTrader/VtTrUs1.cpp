...
VtTrUs1::VtTrUs1(VtSystemType type)
	:VtSystem(type)
{
	InitArgs();
}

VtTrUs1::VtTrUs1(VtSystemType systemType, std::string name)
...
void VtTrUs1::CreateSignal(int startIndex, int endIndex)
{
	if (!_DateTime)
		return;
...
/// <returns></returns>
VtPositionType VtTrUs1::UpdateSignal(int index)
{
	// 시스템 업데이트
	UpdateSystem(index);
...
VtPositionType VtTrUs1::UpdateSignal(int start, int end)
{
...
void VtTrUs1::SetDataMap(VtChartData* chartData)
{
...
void VtTrUs1::SaveToXml(pugi::xml_node& node)
{
...
void VtTrUs1::LoadFromXml(pugi::xml_node& node)
{
...
void VtTrUs1::UpdateSystem(int index)
{
...
bool VtTrUs1::CheckEntranceForBuy()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtTrUs1::CheckEntranceForSell()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtTrUs1::CheckEntranceByBandForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtTrUs1::CheckEntranceByBandForBuy(size_t index)
{
...
bool VtTrUs1::CheckEntranceByBandForSell()
{
	if (!_Symbol)
		return false;
...
bool VtTrUs1::CheckEntranceByBandForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtTrUs1::CheckEntranceByOpenForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtTrUs1::CheckEntranceByOpenForBuy(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtTrUs1::CheckEntranceByOpenForSell()
{
	if (!_Symbol)
		return false;
...
bool VtTrUs1::CheckEntranceByOpenForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtTrUs1::CheckEntranceForBuy(size_t index)
{
...
bool VtTrUs1::CheckEntranceForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtTrUs1::CheckLiqForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtTrUs1::CheckLiqForBuy(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
void VtTrUs1::ReloadSystem(int startIndex, int endIndex)
{
	ClearSignal();
