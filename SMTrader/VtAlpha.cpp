...
VtAlpha::VtAlpha(VtSystemType type)
	:VtSystem(type)
{
	InitArgs();
}

VtAlpha::VtAlpha(VtSystemType systemType, std::string name)
...
void VtAlpha::CreateSignal(int startIndex, int endIndex)
{
	if (!_DateTime)
		return;
...
/// <returns></returns>
VtPositionType VtAlpha::UpdateSignal(int index)
{
	// 시스템 업데이트
	UpdateSystem(index);
...
VtPositionType VtAlpha::UpdateSignal(int start, int end)
{
...
void VtAlpha::SetDataMap(VtChartData* chartData)
{
...
void VtAlpha::SaveToXml(pugi::xml_node& node)
{
...
void VtAlpha::LoadFromXml(pugi::xml_node& node)
{
...
void VtAlpha::UpdateSystem(int index)
{
...
bool VtAlpha::CheckEntranceForBuy()
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
...
bool VtAlpha::CheckEntranceForSell()
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
	std::vector<bool> argCond;
	// 매수 진입
...
VtPositionType VtAlpha::CheckEntranceForBuy(size_t index)
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
	std::vector<bool> argCond;
	// 매수 진입
...
VtPositionType VtAlpha::CheckEntranceForSell(size_t index)
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
	std::vector<bool> argCond;
	// 매수 진입
...
VtPositionType VtAlpha::CheckLiqForSell(size_t index)
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
	VtSymbol* sym = prdtCatMgr->GetRecentFutureSymbol(_T("101F"));
...
VtPositionType VtAlpha::CheckLiqForBuy(size_t index)
{
	VtProductCategoryManager* prdtCatMgr = VtProductCategoryManager::GetInstance();
	VtSymbol* sym = prdtCatMgr->GetRecentFutureSymbol(_T("101F"));
...
void VtAlpha::ReloadSystem(int startIndex, int endIndex)
{
	ClearSignal();
