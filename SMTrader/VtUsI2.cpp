...
VtUsI2::VtUsI2(VtSystemType type)
	:VtSystem(type)
{
	InitArgs();
}

VtUsI2::VtUsI2(VtSystemType systemType, std::string name)
...
void VtUsI2::CreateSignal(int startIndex, int endIndex)
{
	if (!_DateTime)
		return;
...
/// <returns></returns>
VtPositionType VtUsI2::UpdateSignal(int index)
{
	// 시스템 업데이트
	UpdateSystem(index);
...
VtPositionType VtUsI2::UpdateSignal(int start, int end)
{
...
void VtUsI2::SetDataMap(VtChartData* chartData)
{
...
void VtUsI2::SaveToXml(pugi::xml_node& node)
{
...
void VtUsI2::LoadFromXml(pugi::xml_node& node)
{
...
void VtUsI2::UpdateSystem(int index)
{
...
bool VtUsI2::CheckEntranceForBuy()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtUsI2::CheckEntranceForSell()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtUsI2::CheckEntranceByBandForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsI2::CheckEntranceByBandForBuy(size_t index)
{
...
bool VtUsI2::CheckEntranceByBandForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsI2::CheckEntranceByBandForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsI2::CheckEntranceByOpenForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsI2::CheckEntranceByOpenForBuy(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsI2::CheckEntranceByOpenForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsI2::CheckEntranceByOpenForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsI2::CheckEntranceForBuy(size_t index)
{
...
bool VtUsI2::CheckEntranceForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsI2::CheckLiqForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsI2::CheckLiqForBuy(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
void VtUsI2::ReloadSystem(int startIndex, int endIndex)
{
	ClearSignal();
