...
#define CVN_LButtonDownChart 1005
#define CVN_LButtonUpChart 1006
#define CVN_RButtonDownChart 1007
#define CVN_RButtonUpChart 1008
#define CVN_LButtonDblClk  1009
class VtChartWindow;

class CChartViewer : public CStatic, public ViewPortManager
{
private:
	VtChartWindow* _ChartWindow = nullptr;
public:
	CChartViewer();
	...
	VtChartWindow* ChartWindow() const { return _ChartWindow; }
	void ChartWindow(VtChartWindow* val) { _ChartWindow = val; }
	// ClassWizard generated virtual function overrides
...
public:
	afx_msg void OnProductBithumb(UINT id);
	afx_msg void OnUpdateProductBithumb(CCmdUI* pCmdUI);

	afx_msg void OnProductKorbit(UINT id);
	afx_msg void OnUpdateProductCoinwon(CCmdUI* pCmdUI);

	afx_msg void OnProductBitrex(UINT id);
	afx_msg void OnUpdateProductBitrex(CCmdUI* pCmdUI);

	afx_msg void OnProductKraken(UINT id);
	afx_msg void OnUpdateProductKraken(CCmdUI* pCmdUI);

	afx_msg void OnProductBitfinex(UINT id);
	afx_msg void OnUpdateProductBitfinex(CCmdUI* pCmdUI);

	afx_msg void OnProductPoloniex(UINT id);
	afx_msg void OnUpdateProductPoloniex(CCmdUI* pCmdUI);

	afx_msg void OnShowChartCtrl();
	afx_msg void OnUpdateShowChartCtrl(CCmdUI* pCmdUI);

	afx_msg void OnProductCompare0(UINT id);
	afx_msg void OnProductCompare1(UINT id);
	afx_msg void OnProductCompare2(UINT id);
	afx_msg void OnProductCompare3(UINT id);
	afx_msg void OnProductCompare4(UINT id);
	afx_msg void OnProductCompare5(UINT id);

	afx_msg void OnChartPattern(UINT id);
	afx_msg void OnUpdateChartPattern(CCmdUI* pCmdUI);

	afx_msg void OnChartIndex(UINT id);
	afx_msg void OnUpdateChartIndex(CCmdUI* pCmdUI);

	afx_msg void OnDelIndex(UINT id);
	afx_msg void OnDelIndexAll();

	afx_msg void OnInsertIndex(UINT id);
	afx_msg void OnInsertSystem(UINT id);

	afx_msg void OnDelSystem();

	afx_msg void OnInsertBand(UINT id);
	afx_msg void OnInsertStress(UINT id);


	afx_msg void OnRemoveBand(UINT id);
	afx_msg void OnRemoveStress(UINT id);
...
private:
	...
	void SetMouseInfo(UINT a_flags, CPoint a_Point);

	CComboBox* _ComboChartType = nullptr;
