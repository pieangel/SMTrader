...
bool VtUsH2::CheckEntranceForBuyForUsd()
{
...
bool VtUsH2::CheckEntranceForBuyForUsd(size_t index)
{
	std::vector<bool> argCond;
...
bool VtUsH2::CheckEntranceForSellForUsd()
{
	std::vector<bool> argCond;
...
bool VtUsH2::CheckEntranceForSellForUsd(size_t index)
{
	std::vector<bool> argCond;
...
bool VtUsH2::CheckLiqForSellForUsd()
{
	return VtSystem::CheckLiqForSellForUsd();
}

bool VtUsH2::CheckLiqForSellForUsd(size_t index)
{
	return VtSystem::CheckLiqForSellForUsd(index);
}

bool VtUsH2::CheckLiqForBuyForUsd()
{
	return VtSystem::CheckLiqForBuyForUsd();
}

bool VtUsH2::CheckLiqForBuyForUsd(size_t index)
{
