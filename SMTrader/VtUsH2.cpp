...
VtUsH2::VtUsH2(VtSystemType type)
	:VtSystem(type)
{
	InitArgs();
}

VtUsH2::VtUsH2(VtSystemType systemType, std::string name)
...
void VtUsH2::CreateSignal(int startIndex, int endIndex)
{
	if (!_DateTime)
		return;
...
/// <returns></returns>
VtPositionType VtUsH2::UpdateSignal(int index)
{
	// 시스템 업데이트
	UpdateSystem(index);
...
VtPositionType VtUsH2::UpdateSignal(int start, int end)
{
...
void VtUsH2::SetDataMap(VtChartData* chartData)
{
...
void VtUsH2::SaveToXml(pugi::xml_node& node)
{
...
void VtUsH2::LoadFromXml(pugi::xml_node& node)
{
...
void VtUsH2::UpdateSystem(int index)
{
...
bool VtUsH2::CheckEntranceForBuy()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtUsH2::CheckEntranceForSell()
{
	// 밴드에 의한 조건을 먼저 확인한다.
...
bool VtUsH2::CheckEntranceByBandForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsH2::CheckEntranceByBandForBuy(size_t index)
{
...
bool VtUsH2::CheckEntranceByBandForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsH2::CheckEntranceByBandForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsH2::CheckEntranceByOpenForBuy()
{
	if (!_Symbol)
		return false;
...
bool VtUsH2::CheckEntranceByOpenForBuy(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsH2::CheckEntranceByOpenForSell()
{
	if (!_Symbol)
		return false;
...
bool VtUsH2::CheckEntranceByOpenForSell(size_t index)
{
	if (!_Symbol || index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsH2::CheckEntranceForBuy(size_t index)
{
...
bool VtUsH2::CheckEntranceForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsH2::CheckLiqForSell(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
bool VtUsH2::CheckLiqForBuy(size_t index)
{
	if (index < 0 || index >= ChartDataSize)
		return false;
...
void VtUsH2::ReloadSystem(int startIndex, int endIndex)
{
	ClearSignal();
