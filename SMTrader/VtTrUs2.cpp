...
bool VtTrUs2::CheckEntranceForBuyForUsd()
{
...
bool VtTrUs2::CheckEntranceForBuyForUsd(size_t index)
{
	std::vector<bool> argCond;
...
bool VtTrUs2::CheckEntranceForSellForUsd()
{
	std::vector<bool> argCond;
...
bool VtTrUs2::CheckEntranceForSellForUsd(size_t index)
{
	std::vector<bool> argCond;
...
bool VtTrUs2::CheckLiqForSellForUsd()
{
	return VtSystem::CheckLiqForSellForUsd();
}

bool VtTrUs2::CheckLiqForSellForUsd(size_t index)
{
	return VtSystem::CheckLiqForSellForUsd(index);
}

bool VtTrUs2::CheckLiqForBuyForUsd()
{
	return VtSystem::CheckLiqForBuyForUsd();
}

bool VtTrUs2::CheckLiqForBuyForUsd(size_t index)
{
